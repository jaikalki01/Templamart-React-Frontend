const LicenseAgreement = () => {
    return (
        <div className="container mx-auto p-6 max-w-[80rem] mt-[30px] mb-[30px]">
            <h1 className="text-3xl font-bold mb-4">LICENSE AGREEMENT</h1>
            <p className="mb-2 text-muted-foreground"><b>Version 1.0 | Effective Date:</b> 31st March 2025</p>

            <h2 className="text-2xl font-semibold mt-4 mb-4">1. GRANT OF LICENSE</h2>
            <p className="text-muted-foreground">Upon successful purchase or authorized download, Licensor grants Licensee a nonexclusive, nontransferable, worldwide, revocable license to use the purchased Template subject to the terms outlined herein. The granted license is limited to the following:</p>
            <ol className="ml-6 mb-4 text-muted-foreground">
            ...
            <p className="text-muted-foreground">Due to the digital nature of Templates, refunds are only considered under the following conditions:</p>
            ...
            <p className="text-muted-foreground">This Agreement is valid until terminated. Licensor reserves the right to terminate this License
            ...
            <p className="text-muted-foreground">ALL TEMPLATES ARE PROVIDED &quot;AS IS&quot; WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED.
...
MERCHANTABILITY, OR NONINFRINGEMENT.</p>
            ...
            <p className="text-muted-foreground">LICENSOR SHALL NOT BE LIABLE FOR ANY DAMAGES, INCLUDING BUT NOT LIMITED TO, LOSS OF
...
TEMPLATES, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
            ...
            <p className="text-muted-foreground">This Agreement shall be governed by and construed under the laws of India. Any disputes shall be
...
and binding.</p>
            ...
            <p className="text-muted-foreground">Licensor reserves the right to modify this Agreement at any time. The updated Agreement will be
posted on Templamart.com, and continued use of the Templates constitutes acceptance of the new
terms.</p>

            <p className="font-bold mt-6 text-muted-foreground  ">BY PURCHASING OR DOWNLOADING A TEMPLATE FROM TEMPLAMART.COM, YOU ACKNOWLEDGE
